...
class Scratch: 
  def __init__(self, f_saved): 
    ...
    # <retention> TODO 
    self.retention = 5
    # In the __init__ function of the Scratch class

    self.living_area = None
    self.weather = "" # <--- ADD THIS LINE
    # In the __init__ function of the Scratch class

# ... existing variables
    self.planned_path = []

    # --- NEW AFFECTIVE MEMORY ---
    self.affective_state = {"happiness": 0, "sadness": 0, "anger": 0}
    self.emotional_decay = 0.95 # Mood fades over time
    # --- END NEW AFFECTIVE MEMORY ---
